...
The merchant, [Merchant Name], is clearly a [restaurant/hotel/airline/etc.] based on [attach evidence: website link, Google Maps listing, customer reviews]. This merchant should be coded as MCC [code number] per the Visa/Mastercard MCC table.

**Impact:**
My card offers [X bonus] on MCC [correct code]. Due to this miscode, I received only [Y bonus] instead of [X bonus], resulting in a loss of approximately $[amount] in rewards.
