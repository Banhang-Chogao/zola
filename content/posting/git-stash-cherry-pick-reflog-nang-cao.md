...
> 📚 **Git & GitHub Series (Bài 11/15)** — Tiếp nối phần nâng cao sau [git rebase ở Bài 10](/zola/posting/git-rebase-lam-sach-lich-su-commit/), bài này giới thiệu ba "phao cứu sinh": **git stash**, cherry-pick và reflog.
...
Ba công cụ này bổ trợ cho kỹ năng [reset và revert ở Bài 12](/zola/posting/git-reset-revert-khoi-phuc-su-co/), tạo thành bộ đồ nghề xử lý sự cố hoàn chỉnh.
...
Ở **Bài 12**, chúng ta học cách quay ngược thời gian có chủ đích với [git reset, revert và khôi phục sự cố](/zola/posting/git-reset-revert-khoi-phuc-su-co/).
