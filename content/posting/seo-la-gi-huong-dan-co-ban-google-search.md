...
2. **Bài 2**: [Google Search hoạt động thế nào](/google-search-hoat-dong-the-nao/) — crawl, index, serve.
...
Nếu bạn đang xây blog tĩnh, đọc thêm [tự động deploy Zola bằng GitHub Actions](/tu-dong-deploy-zola-github-actions/) để mỗi bài mới được build và lên production — SEO không có tác dụng nếu Google crawl bản cũ.
