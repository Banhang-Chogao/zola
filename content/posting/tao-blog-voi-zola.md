...
> Muốn hiểu sâu hơn về stack vận hành một blog tĩnh thực tế (CMS mini, CI/CD, tự động hoá), đọc thêm bài [Tự xây blog cá nhân $0/tháng với Zola + GitHub Pages](/cong-nghe-blog-duy-nguyen/).
...
Vào **Settings → Pages** của repo, ở mục *Build and deployment* chọn **Source = GitHub Actions**. Từ giờ mỗi lần `git push` lên nhánh `main`, blog tự build và lên sóng. Đây cũng là nền tảng để [tự động hoá QA và self-healing CI](/qa-gatekeeper-tu-fix-loi-blog/) sau này.
...
Nếu bạn tò mò một blog Zola "đời thực" được vận hành thế nào — từ CMS mini viết bằng vanilla JS đến hệ thống tự fix lỗi — hãy đọc tiếp [Tự xây blog cá nhân $0/tháng](/cong-nghe-blog-duy-nguyen/) và [QA Gatekeeper: blog tự fix lỗi 24/7](/qa-gatekeeper-tu-fix-loi-blog/).
