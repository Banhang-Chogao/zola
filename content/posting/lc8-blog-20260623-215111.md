+++
title = "+++"
description = "title = 'Vì sao Zola Smoke Test chạy lâu? Nhật ký tối ưu một blog 500+ trang và kế hoạch đưa ảnh lên Cloudflare R2' description = 'Khi blog Zola lớn dần, CI/..."
date = 2026-06-23
[taxonomies]
...
title = "Vì sao Zola Smoke Test chạy lâu? Nhật ký tối ưu một blog 500+ trang và kế hoạch đưa ảnh lên Cloudflare R2" description = "Khi blog Zola lớn dần, CI/CD không còn nhẹ như ngày đầu. Đây là nhật ký debug Zola Smoke Test chạy lâu, vì sao build tĩnh vẫn có thể nặng, và cách tối ưu bằng Quick Gate, cache, dọn workflow cũ, cùng kế hoạch offload ảnh sang Cloudflare R2." date = 2026-06-23 [taxonomies] categories = ["Tất cả", "Công nghệ"] tags = ["Zola", "GitHub Actions", "CI/CD", "Cloudflare R2", "WebOps", "SEOMONEY"] +++
