...
tags = ["git", "github", "github là gì", "git github series", "lập trình"]
[extra]
...
> 📚 **Git & GitHub Series (Bài 7/15)** — Đã nắm [git remote ở Bài 6](/zola/posting/git-remote-lam-viec-voi-repository-tu-xa/), giờ ta chính thức bước vào **GitHub** — nơi remote của bạn sẽ sống.
...
Nhắc lại từ [Bài 1](/zola/posting/git-la-gi-version-control-cho-nguoi-moi/) vì đây là điểm gây nhầm nhất:
...
3. Xác minh email.
4. **Bật xác thực hai lớp (2FA)** ngay trong Settings → đây là yêu cầu bảo mật quan trọng, sẽ bàn kỹ ở [Bài 15](/zola/posting/bao-mat-best-practices-git-github/).
...
Nếu bạn đã có dự án local từ [Bài 3](/zola/posting/lenh-git-co-ban-init-add-commit-status/), hãy kết nối nó:
...
Lệnh `push -u` đẩy code lên và thiết lập nhánh theo dõi, để lần sau chỉ cần `git push`. Chi tiết về push sẽ ở [Bài 8](/zola/posting/push-pull-fetch-dong-bo-voi-github/).
...
Ở **Bài 8**, chúng ta đi sâu vào ba thao tác đồng bộ cốt lõi: [push, pull và fetch để đồng bộ code với GitHub](/zola/posting/push-pull-fetch-dong-bo-voi-github/).
