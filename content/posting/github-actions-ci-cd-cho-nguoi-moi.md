...
> 📚 **Git & GitHub Series (Bài 14/15)** — Sau khi chọn được [git workflow ở Bài 13](/git-workflow-chuyen-nghiep-gitflow-github-flow/), giờ ta tự động hóa nó bằng **GitHub Actions**.
...
Đây là nguyên tắc bảo mật quan trọng, sẽ được nhấn mạnh ở [Bài 15](/bao-mat-best-practices-git-github/).
...
Bài cuối — **Bài 15** — khép lại series với những điều quan trọng nhất về [bảo mật và best practices với Git/GitHub](/bao-mat-best-practices-git-github/).
