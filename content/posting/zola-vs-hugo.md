...
> Mới tinh? Xem trước [hướng dẫn tạo blog với Zola từ A–Z](/tao-blog-voi-zola/) để hình dung quy trình.
...
Đọc tiếp: [tạo blog với Zola từ A–Z](/tao-blog-voi-zola/) và [tự động deploy lên GitHub Pages bằng GitHub Actions](/tu-dong-deploy-zola-github-actions/).
