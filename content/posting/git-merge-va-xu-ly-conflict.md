...
> 📚 **Git & GitHub Series (Bài 5/15)** — Đã biết tạo nhánh ở [Bài 4 về git branch](/git-branch-lam-viec-voi-nhanh/), giờ ta học cách gộp chúng lại bằng **git merge** và xử lý xung đột.
...
Trên blog này, hệ thống tự động còn có cả [bot tự sửa conflict](/qa-gatekeeper-tu-fix-loi-blog/) cho các trường hợp đơn giản, nhưng hiểu quy trình thủ công vẫn là kỹ năng nền tảng.
...
Ở **Bài 6**, chúng ta đưa Git ra khỏi máy cá nhân: [làm việc với repository từ xa qua git remote](/git-remote-lam-viec-voi-repository-tu-xa/) — bước đệm trước khi lên GitHub ở Bài 7.
