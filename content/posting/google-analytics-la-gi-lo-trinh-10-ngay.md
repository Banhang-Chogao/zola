...
![Infographic: sơ đồ Google Analytics thu thập dữ liệu từ website về dashboard](/zola/img/placeholder/placeholder-wide.svg)
...
![Infographic: bản đồ các nhóm báo cáo chính trong GA4](/zola/img/placeholder/placeholder-wide.svg)
...
| 3–4 | [Bài 2 — Users, New Users, Sessions](/zola/posting/users-new-users-sessions-google-analytics/) | Phân biệt 3 chỉ số dễ nhầm nhất |
...
Lộ trình này giả định bạn đã có một website. Nếu chưa, bạn có thể bắt đầu từ bài [tạo blog với Zola](/zola/posting/tao-blog-voi-zola/) rồi quay lại đây. Và nếu mục tiêu cuối của bạn là thứ hạng tìm kiếm, nên đọc song song [SEO là gì](/zola/posting/seo-la-gi-huong-dan-co-ban-google-search/) và [Google Search hoạt động thế nào](/zola/posting/google-search-hoat-dong-the-nao/) — Analytics và SEO là hai mặt của một đồng xu.
...
Với blog tĩnh, mình thích cách chèn tag vào template chung (file `base.html` chẳng hạn) để mọi trang đều được đo. Nếu bạn dùng Zola, có thể tham khảo cách mình dựng site trong bài [tạo blog với Zola](/zola/posting/tao-blog-voi-zola/) rồi chèn tag vào layout.
...
👉 **Đọc tiếp:** [Bài 2 — Users, New Users và Sessions: 3 chỉ số khiến người mới dễ nhầm nhất](/zola/posting/users-new-users-sessions-google-analytics/). Đây là ba con số bạn sẽ nhìn mỗi ngày, nên hiểu cho đúng từ đầu. Toàn bộ series nằm trong chuyên mục [Công nghệ](/zola/categories/cong-nghe/).
