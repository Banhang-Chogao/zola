...
Theo cách hiểu chung về an toàn ngân hàng số, các lớp thường thấy gồm: bước đăng nhập, bước xác nhận giao dịch, mã hóa dữ liệu khi truyền, và hệ thống giám sát phía sau. Cách tiếp cận nhiều lớp này là chuẩn mực ngành, gắn liền với câu chuyện [chuyển đổi số VietinBank](/chuyen-doi-so-tai-vietinbank-chien-luoc-ket-qua/) mà mình kể ở bài trước — càng nhiều giao dịch số, bảo mật càng phải chặt.
...
Lớp tiếp theo là **sinh trắc học** — vân tay, khuôn mặt. Mình từng nhắc tới nó trong [bài về công nghệ và trải nghiệm khách hàng](/vietinbank-cong-nghe-trai-nghiem-khach-hang/), nhưng ở đây nó đóng vai trò an toàn rõ hơn.
...
Những lớp này là phần "vô hình" của bảo mật. Người dùng không cần làm gì, nhưng chúng âm thầm bảo vệ tài khoản mỗi ngày. Nền tảng để chạy được các lớp này cũng liên quan tới [quá trình hiện đại hóa core banking](/vietinbank-hien-dai-hoa-core-banking/) mà mình từng kể.
...
Bạn có thể quay lại [bài về chuyển đổi số VietinBank](/chuyen-doi-so-tai-vietinbank-chien-luoc-ket-qua/), ghé [chuyên mục Ngân hàng](/topic/ngan-hang/), hoặc đọc lại [bài mở đầu loạt VietinBank](/vietinbank-la-ai-hanh-trinh-hinh-thanh/).

> 👉 **Đọc tiếp:** [VietinBank trong cuộc đua ngân hàng số với BIDV, Vietcombank và Agribank →](/vietinbank-cuoc-dua-ngan-hang-so-big4/)
