...
a = "/zola/ prefix là hardcoded pattern — script chỉ chấp nhận link `/zola/posting/...`. File existence check thực tế kiểm tra xem file đó có tồn tại trong public/ không, đúng với cách site deploy thực tế."
...
```markdown
- [Cách setup Zola series navigation](/zola/posting/zola-series-nav-setup/) — thiếu
- [SEO best practices cho series](/zola/posting/seo-series-articles/) — thiếu
- [Debugging Zola build issues](/zola/posting/zola-build-debug-templates/) — thiếu
```
...
```markdown
- [Tạo blog với Zola từ A–Z](/zola/posting/tao-blog-voi-zola/)
- [Tự động deploy Zola với GitHub Actions](/zola/posting/tu-dong-deploy-zola-github-actions/)
- [Zola vs Hugo: so sánh chi tiết](/zola/posting/zola-vs-hugo/)
```
...
- [Debug Lỗi Zola Series Navigation: Từ 11 Broken Links Đến Fix](/zola/posting/debug-zola-series-navigation-links/) — phân tích Zola-specific issue
- [Tạo blog với Zola từ A–Z](/zola/posting/tao-blog-voi-zola/) — setup Zola site đúng cách
- [Tự động deploy Zola với GitHub Actions](/zola/posting/tu-dong-deploy-zola-github-actions/) — CI/CD pipeline
