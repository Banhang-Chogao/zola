...
**AI Cluster:**
- [10 vaccine CLAUDE.md](/zola/10-vaccine-claude-md-giam-loi-production/)
- [QA Gatekeeper & Vaccine Autofixer](/zola/qa-gatekeeper-vaccine-autofixer/)
- [FAQ Schema ngân hàng](/zola/faq-schema-cluster-ngan-hang-ctr/) — output của pipeline
...
Tôi đặt **10 vaccine** trong CLAUDE.md — chi tiết ở [Bài 2](/zola/10-vaccine-claude-md-giam-loi-production/). Ví dụ:
...
Sau khi AI viết xong, [QA Gatekeeper](/zola/qa-gatekeeper-vaccine-autofixer/) chạy checklist:
...
- [Finance cluster](/zola/vssid-khong-hien-qua-trinh-dong-bhtn/)
