...
a = "Có — staging/production mirror nên noindex toàn site hoặc password-protect; robots.txt Disallow một mình không đủ nếu URL lộ (backlink, sitemap nhầm). Production blog chính thức: bỏ noindex, kiểm tra Search Console sau deploy ([Bài 5](/google-nhin-trang-giong-nguoi-dung/))."
+++

> 📚 **SEO Foundation Series (Bài 6/15)** — Sau [Bài 1: SEO là gì & Search Essentials](/seo-la-gi-huong-dan-co-ban-google-search/), [Bài 2: Google Search hoạt động — crawl, index, ranking](/google-search-hoat-dong-the-nao/), [Bài 3: Bao lâu để thấy kết quả SEO?](/bao-lau-de-thay-ket-qua-seo/), [Bài 4: Giúp Google tìm nội dung](/giup-google-tim-noi-dung-site/) và [Bài 5: Google có nhìn thấy trang giống người dùng?](/google-nhin-trang-giong-nguoi-dung/), bài này trả lời câu hỏi đối lập discovery: **khi nào và làm sao chặn trang khỏi Google Search?** Tôi bám mục *Don't want a page in search results?* trong [Google SEO Starter Guide](https://developers.google.com/search/docs/fundamentals/seo-starter-guide) và [block search indexing](https://developers.google.com/search/docs/crawling-indexing/robots-meta-tag).

[Bài 4](/giup-google-tim-noi-dung-site/) giúp Google **tìm** URL. [Bài 5](/google-nhin-trang-giong-nguoi-dung/) đảm bảo Google **đọc đủ** nội dung. **Bài 6** = kiểm soát **không** muốn URL trên SERP — admin, duplicate, thin utility, staging.
...
[Bài 2](/google-search-hoat-dong-the-nao/) đã tách crawl vs index. **Chặn index** = quyết định ở bước **index**, sau khi Google **có thể** đã crawl ([Bài 5](/google-nhin-trang-giong-nguoi-dung/)).

Không chặn đúng → **crawl budget** lãng phí ([Bài 4](/giup-google-tim-noi-dung-site/)), duplicate loãng topical authority, hoặc **lộ** path admin trên SERP.
...
- `noindex` có hiệu lực khi Google **fetch lại** — timeline [Bài 3](/bao-lau-de-thay-ket-qua-seo/).
...
[Bài 4](/giup-google-tim-noi-dung-site/) đã nhắc sitemap + robots. **Bài 6** nhấn **Disallow** = giảm crawl path utility — **không** thay noindex nếu URL vẫn cần "chắc chắn không SERP".
...
**Search Console** URL Inspection hiển thị cả meta và header — [Bài 5](/google-nhin-trang-giong-nguoi-dung/) workflow vẫn áp dụng để verify.
...
### Đối lập [Bài 4](/giup-google-tim-noi-dung-site/)
...
3. **Gỡ** khỏi sitemap.
4. Đợi Google recrawl — [Bài 3](/bao-lau-de-thay-ket-qua-seo/) timeline.
...
**Mediapartners-Google**, **AdsBot-Google** Allow — đồng bộ [AdSense series](/google-adsense-la-gi-chinh-sach-chuong-trinh/) crawl ad relevance.

### Bài posting series

- **Không** noindex — `draft = false`, trong sitemap.
- Sau publish: URL Inspection [Bài 5](/google-nhin-trang-giong-nguoi-dung/) — xác nhận **không** có `noindex` nhầm.
...
Production `base_url` — internal link và sitemap dùng `/zola/...` — robots và noindex áp cùng path ([Bài 4](/giup-google-tim-noi-dung-site/)).
...
**"nofollow internal link pillar"** — Không thay noindex; làm yếu [Bài 4](/giup-google-tim-noi-dung-site/) cluster.
...
- [ ] **Không** noindex — verify URL Inspection [Bài 5](/google-nhin-trang-giong-nguoi-dung/).
- [ ] **robots.txt** không Disallow path bài.
- [ ] Trong **sitemap** — [Bài 4](/giup-google-tim-noi-dung-site/).
- [ ] **Internal link** từ series 1–5.

### Sau deploy

- [ ] Test 1 URL posting + 1 URL admin.
- [ ] Ghi ngày — recheck nếu đổi template ([Bài 3](/bao-lau-de-thay-ket-qua-seo/)).
...
Chưa giúp Google tìm URL? [Bài 4](/giup-google-tim-noi-dung-site/). Chưa verify render? [Bài 5](/google-nhin-trang-giong-nguoi-dung/).
...
Pipeline: tìm URL ([Bài 4](/giup-google-tim-noi-dung-site/)) → Google thấy nội dung ([Bài 5](/google-nhin-trang-giong-nguoi-dung/)) → **quyết định index hay noindex** (**Bài 6**) → tổ chức site (Bài 7). Blog Zola: robots.txt chặn utility, posting public trong sitemap — kiểm tra bằng URL Inspection sau deploy.
