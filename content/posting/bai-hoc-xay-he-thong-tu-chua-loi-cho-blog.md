...
Xem [10 Vaccine CLAUDE.md](/posting/10-vaccine-claude-md-giam-loi-production/) để thấy ví dụ cụ thể về ranh giới safe/risky fix, và bài [QA Gatekeeper](/posting/qa-gatekeeper-vaccine-autofixer/) về cách pipeline kiểm tra hoạt động.
