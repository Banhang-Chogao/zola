+++
title = "Khi nào chữ ký số thật sự có giá trị pháp lý?"
date = 2026-06-22
aliases = ["/khi-nao-chu-ky-so-co-gia-tri-phap-ly/"]
description = "Khi nào chữ ký số có giá trị pháp lý? Tổng hợp các điều kiện theo Luật Giao dịch điện tử 2023 và Nghị định 23/2025, kèm checklist tôi tự dùng trước khi ký."
slug = "khi-nao-chu-ky-so-co-gia-tri-phap-ly"
...
Ở [bài 4](/trai-nghiem-ky-so-tu-xa-mysign-viettel-ca/), tôi đã ký thành công một file PDF. Về mặt kỹ thuật, mọi thứ hoàn hảo. Nhưng giá trị pháp lý không nằm ở chỗ thao tác ký trơn tru — nó nằm ở chỗ chữ ký đó có đáp ứng các điều kiện mà pháp luật đặt ra hay không.
...
Dựa trên tinh thần của [Luật Giao dịch điện tử 2023](https://vanban.chinhphu.vn/) và Nghị định 23/2025, tôi tóm lại các điều kiện cốt lõi:

1. **Xác định được người ký.** Chữ ký phải gắn với một danh tính xác thực — đây là lý do MySign bắt xác thực căn cước và khuôn mặt khi đăng ký.
2. **Người ký kiểm soát được dữ liệu tạo chữ ký.** Khóa bí mật phải thuộc quyền kiểm soát của riêng tôi (qua PIN, sinh trắc học), không bị người khác dùng thay.
3. **Phát hiện được mọi thay đổi sau khi ký.** Nếu nội dung bị sửa, chữ ký phải trở nên không hợp lệ — đảm bảo tính toàn vẹn.
4. **Được bảo đảm bằng chứng thư hợp lệ.** Chứng thư chữ ký số phải do tổ chức cung cấp dịch vụ được cấp phép phát hành, và **còn hiệu lực tại thời điểm ký**.
...
Cảm ơn bạn đã đọc hết series. Nếu mới bắt đầu, bạn có thể quay lại [bài mở đầu](/toi-moi-mua-mysign-chu-ky-so-ca-nhan-dung-de-lam-gi/) để đọc theo đúng thứ tự.
...
- Bài 4: [Trải nghiệm ký số từ xa với MySign của Viettel-CA](/trai-nghiem-ky-so-tu-xa-mysign-viettel-ca/)
