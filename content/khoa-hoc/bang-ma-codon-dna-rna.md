...
date = 2026-06-27
aliases = ["/baochi/bang-ma-codon-dna-rna/"]
[taxonomies]
categories = ["Tất cả", "Khoa học", "Kiến thức"]
tags = ["sinh-học", "di-truyền-học", "codon", "dna", "rna", "protein", "khoa-học"]
[extra]
seo_keyword = "bảng mã codon DNA RNA"
thumbnail = "https://picsum.photos/seed/bang-ma-codon-dna-rna/600/400"
featured = false
[[extra.references_external]]
title = "Wikipedia (Tiếng Việt) — Bảng mã codon DNA và RNA"
url = "https://vi.wikipedia.org/wiki/B%E1%BA%A3ng_m%C3%A3_codon_DNA_v%C3%A0_RNA"
[[extra.faq]]
q = "Codon là gì?"
a = "Codon là một bộ ba nucleotide (3 chữ cái) trên mRNA hoặc DNA, mỗi codon mã hóa cho một amino acid hoặc tín hiệu kết thúc/mở đầu dịch mã. Có tổng cộng 64 codon khác nhau trong mã di truyền chuẩn."
[[extra.faq]]
q = "Sự khác biệt giữa bảng mã codon RNA và DNA là gì?"
a = "Bảng codon RNA dùng uracil (U) thay cho thymin (T) trong DNA. Đây là điểm khác biệt duy nhất — UUU trong RNA tương đương TTT trong DNA, cùng mã hóa cho phenylalanin."
[[extra.faq]]
q = "Tại sao có codon mở đầu và codon kết thúc?"
a = "Codon mở đầu (AUG) báo hiệu ribosome bắt đầu tổng hợp protein. Codon kết thúc (UAA, UAG, UGA) ra lệnh giải phóng chuỗi polypeptide sau khi tổng hợp xong — giống như dấu chấm câu trong câu văn."
[[extra.faq]]
q = "Mã di truyền có phải là phổ quát không?"
a = "Không hoàn toàn. Mã di truyền 'chuẩn' áp dụng cho hầu hết sinh vật, nhưng các bào quan như ty thể, lạp thể và một số sinh vật đơn bào có mã di truyền thay thế — cùng codon nhưng dịch sang amino acid khác."
[[extra.faq]]
...
Nếu bạn muốn đọc thêm về những ứng dụng khoa học liên quan đến năng lượng hạt nhân và nguyên tử — một lĩnh vực khoa học khác cũng đang thay đổi thế giới — hãy xem bài [Nhà máy làm giàu uranium hoạt động thế nào?](/posting/nha-may-lam-giau-uranium-hoat-dong-the-nao/).

> 📚 Bài viết tham khảo và biên soạn lại từ Wikipedia (CC BY-SA). Xem bản gốc: [Tiếng Việt](https://vi.wikipedia.org/wiki/B%E1%BA%A3ng_m%C3%A3_codon_DNA_v%C3%A0_RNA).
