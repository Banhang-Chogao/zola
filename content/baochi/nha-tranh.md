+++
title = "Nhà tranh — Biểu tượng mộc mạc của làng quê Việt Nam"
description = "Nhà tranh là loại hình nhà ở truyền thống gắn liền với nông thôn Việt Nam, được xây từ tre nứa, rơm rạ và bùn đất. Tìm hiểu về kiến trúc và văn hóa nhà tranh."
date = 2026-06-28

[taxonomies]
categories = ["Tất cả", "Kiến thức"]
...
original_source_type = "knowledge_article"
category_confidence = 0.88
category_reason = "Bài viết về kiến trúc truyền thống, văn hóa làng quê và vật liệu tự nhiên."

[[extra.faq]]
q = "Nhà tranh có bền không?"
a = "Một căn nhà tranh được dựng tốt có thể ở được 10-20 năm. Mái tranh cần lợp lại sau 3-5 năm, vách đất cần trát lại khi bị nứt. Nếu được bảo dưỡng thường xuyên, tuổi thọ có thể kéo dài hơn nhiều."

[[extra.faq]]
q = "Nhà tranh có sợ cháy không?"
a = "Có, đây là nhược điểm lớn nhất. Tranh rơm rất dễ cháy. Ngày nay người ta có thể xử lý chống cháy bằng hóa chất hoặc trộn bùn vào vật liệu lợp để giảm nguy cơ."

[[extra.faq]]
q = "Nhà tranh tiếng Anh gọi là gì?"
a = "Có hai cách gọi: thatched house (nhà) hoặc thatched cottage (nhà nhỏ/ nhà gỗ). Nghề lợp tranh gọi là thatching."

[[extra.faq]]
q = "Vì sao nhà tranh ở Việt Nam thường gắn với nghèo khó?"
a = "Vì trong xã hội cũ, ai có điều kiện sẽ làm nhà ngói. Nhà tranh là lựa chọn bắt buộc cho người nghèo vì chi phí gần như bằng không — chỉ tốn công. Ở châu Âu, nhà tranh lại mang tính thẩm mỹ và văn hóa hơn là kinh tế."

[[extra.faq]]
q = "Có thể xây nhà tranh ở thành phố không?"
a = "Về mặt kỹ thuật thì được, nhưng hầu hết nơi không cho phép vì quy định xây dựng về phòng cháy. Một số quốc gia như Anh có quy định riêng cho nhà tranh di sản, được phép bảo tồn nhưng khó xây mới."

[[extra.faq]]
q = "Nhà tranh có phải là kiến trúc bền vững không?"
a = "Hoàn toàn. Vật liệu tự nhiên, không xi măng, không thép, ít carbon. Nhà tranh là một trong những mô hình nhà ở bền vững nhất mà con người từng có, trước khi cuộc cách mạng công nghiệp làm thay đổi mọi thứ."

[[extra.references_external]]
title = "Wikipedia (Tiếng Việt) — Nhà tranh"
url = "https://vi.wikipedia.org/wiki/Nh%C3%A0_tranh"

[[extra.references_external]]
title = "Wikipedia (English) — Thatching"
...
Xem bản gốc: [Nhà tranh](https://vi.wikipedia.org/wiki/Nh%C3%A0_tranh) · [Thatching](https://en.wikipedia.org/wiki/Thatching)  
Ảnh: [Michael Gäbler](https://commons.wikimedia.org/wiki/User:Michael_G%C3%A4bler) qua Wikimedia Commons.
