...
[[extra.faq]]
q = "Doanh nghiệp nợ thuế có được hoàn thuế GTGT không?"
a = "Không. Nếu người nộp thuế còn nợ tiền thuế GTGT, tiền chậm nộp hoặc tiền phạt, phần thuế của các hóa đơn/kỳ liên quan sẽ không được hoàn — chỉ được kết chuyển khấu trừ sau khi đã nộp đủ nghĩa vụ thuế."
[[extra.faq]]
q = "Thanh toán bằng tiền mặt có được hoàn thuế GTGT không?"
a = "Thường là không. Để được khấu trừ và hoàn thuế GTGT đầu vào, doanh nghiệp cần có chứng từ thanh toán không dùng tiền mặt (ủy nhiệm chi, giấy báo có của ngân hàng). Hóa đơn thanh toán bằng tiền mặt rất dễ bị loại khỏi diện hoàn thuế."
[[extra.faq]]
q = "Thuế GTGT đầu vào chưa khấu trừ hết có được hoàn không?"
a = "Không phải lúc nào cũng được. Nếu chỉ có số thuế đầu vào chưa khấu trừ hết nhưng không thuộc các trường hợp được hoàn theo quy định (ví dụ xuất khẩu, dự án đầu tư đủ điều kiện), bạn chỉ được chuyển tiếp khấu trừ sang kỳ sau chứ không được hoàn tiền."
[[extra.faq]]
...
Kinh nghiệm của mình gói gọn trong mấy việc: rà soát sổ sách, hóa đơn định kỳ thay vì để dồn; đối chiếu thông tin trên hồ sơ với giấy tờ gốc (mã số thuế, hợp đồng, tài khoản); ưu tiên thanh toán chuyển khoản để giữ chứng từ hợp lệ; và xác định đúng cơ quan thuế trước khi nộp. Với doanh nghiệp nhỏ, một thói quen theo dõi dòng tiền và chứng từ gọn gàng giúp ích rất nhiều — bạn có thể tham khảo cách mình dựng [công cụ phân tích dòng tiền cá nhân](@/tools/f-dashboard.md) để hình dung tư duy "số liệu phải sạch và đối chiếu được".
...
> **Xem thêm trong cụm:** [Chuyên mục Ngân hàng — tin & hướng dẫn](/zola/categories/ngan-hang/)
