+++
title = "Kính Hubble: Cửa sổ vào bí ẩn của vũ trụ"
description = "Kính viễn vọng Hubble đã thay đổi cách chúng ta nhìn nhận vũ trụ, từ khám phá những lỗ đen đến chứng minh sự giãn nở của vũ trụ."
date = 2026-06-28

[taxonomies]
categories = ["Tất cả", "Khoa học", "Kiến thức"]
tags = ["khoa-học", "vũ-trụ", "thiên-văn-học", "công-nghệ", "khám-phá", "nasa"]

[extra]
thumbnail = "https://picsum.photos/seed/kinh-hubble/600/400"
seo_keyword = "kính Hubble"
featured = false
source = "bb10"
content_origin = "wikipedia"
original_source_type = "knowledge_article"
category_confidence = 0.95
category_reason = "Bài viết về thiên văn học, công nghệ vũ trụ và khám phá khoa học."

[[extra.references_external]]
title = "Wikipedia (Tiếng Việt) — Kính viễn vọng không gian Hubble"
url = "https://vi.wikipedia.org/wiki/K%C3%ADnh_vi%E1%BB%85n_v%E1%BB%8Dng_kh%C3%B4ng_gian_Hubble"

[[extra.references_external]]
title = "Wikipedia (English) — Hubble Space Telescope"
url = "https://en.wikipedia.org/wiki/Hubble_Space_Telescope"
+++

Có một thứ mà mình vô cùng yêu thích trong [khoa học](/categories/khoa-hoc/) hiện đại — đó là những dự án táo bạo khiến toàn bộ nhân loại cùng nhìn lên và thốt lên: "Chúng ta đã làm được điều gì thực sự kỳ diệu đây?" Và kính viễn vọng Hubble chính là một trong những ví dụ hoàn hảo về điều đó.
...
Nhắc tới các sứ mệnh sửa chữa và bảo trì Hubble trên quỹ đạo, không thể không nhắc tới đội tàu con thoi đã giúp thực hiện chúng — trong đó có [tàu con thoi Atlantis](/baochi/tau-con-thoi-atlantis/), một trong những "công thần" của chương trình không gian NASA.
...
📚 **Bài viết tham khảo và biên soạn lại từ Wikipedia (CC BY-SA).** Xem bản gốc: [Tiếng Việt](https://vi.wikipedia.org/wiki/K%C3%ADnh_vi%E1%BB%85n_v%E1%BB%8Dng_kh%C3%B4ng_gian_Hubble) · [English](https://en.wikipedia.org/wiki/Hubble_Space_Telescope).

Bạn có thể xem thêm các bài trong chuyên mục [Kiến thức](/categories/kien-thuc/) của blog, hoặc [toàn bộ bài viết](/categories/tat-ca/) nếu muốn khám phá thêm nhiều chủ đề khác. Nếu đây là lần đầu ghé blog, [tìm hiểu thêm về mình](/posting/chao-mung-den-voi-duy-nguyen/).
