+++
title = "Ngày 18 — Phủ định 안 / 못 & -지 않다 trong tiếng Hàn"
description = "Học tiếng Hàn ngày 18: phủ định với 안 (không) và 못 (không thể), dạng dài -지 않다, -지 못하다. Phân biệt 안 vs 못 rõ ràng. Series Premium 30 ngày → TOPIK."
date = 2026-06-18
aliases = ["/phu-dinh-an-mot-tieng-han/",
  "/posting/phu-dinh-an-mot-tieng-han/"
]

[taxonomies]
categories = ["Tất cả", "premium", "Học tiếng Hàn"]
tags = ["hoc tieng han series", "học tiếng hàn", "ngữ pháp tiếng hàn", "phủ định tiếng hàn", "tiếng hàn sơ cấp", "topik"]
[extra]
premium = true
price = 49000
premium_post_id = "premium-han30-18"
...
[[extra.faq]]
q = "안 và 못 trong tiếng Hàn khác nhau thế nào?"
a = "안 phủ định ý chí hoặc sự thật ('không làm' do không muốn/không phải vậy): 안 가요 = không đi. 못 phủ định khả năng ('không thể làm dù muốn'): 못 가요 = không đi được. Ngày 18 có bảng so sánh 안 vs 못 chi tiết kèm ví dụ."

[[extra.faq]]
q = "Dạng phủ định dài -지 않다 và -지 못하다 dùng khi nào?"
a = "-지 않다 là dạng dài tương đương 안 (가지 않아요 = 안 가요), -지 못하다 tương đương 못 (가지 못해요 = 못 가요). Dạng dài trang trọng và nhấn mạnh hơn, hay gặp trong văn viết. Bài học hướng dẫn cách đổi qua lại."

[[extra.faq]]
q = "Phủ định động từ 하다 (như 공부하다) trong tiếng Hàn thế nào?"
...
Đặt **안** ngay **trước** động từ hoặc tính từ. Nghĩa: "không (làm)" vì **không muốn** hoặc **sự thật là không**.

| Câu khẳng định | Phủ định với 안 | Nghĩa |
|:---:|:---:|---|
| 가요 (đi) | **안** 가요 | không đi (không muốn đi) |
| 먹어요 (ăn) | **안** 먹어요 | không ăn |
| 비싸요 (đắt) | **안** 비싸요 | không đắt |
| 좋아요 (thích) | **안** 좋아요 | không thích / không tốt |
...
Đặt **못** ngay **trước** động từ (chỉ dùng với **động từ hành động**, không dùng với tính từ). Nghĩa: "không thể (làm)" dù **muốn cũng chịu**.

| Câu khẳng định | Phủ định với 못 | Nghĩa |
|:---:|:---:|---|
| 가요 (đi) | **못** 가요 | không đi *được* (bận/ốm) |
| 먹어요 (ăn) | **못** 먹어요 | không ăn *được* (dị ứng) |
| 자요 (ngủ) | **못** 자요 | không ngủ *được* |
| 마셔요 (uống) | **못** 마셔요 | không uống *được* (rượu) |
...
| Tiêu chí | 안 | 못 |
|---|---|---|
| Nghĩa | không (làm) | không thể (làm) |
| Lý do | ý chí / sự thật | thiếu khả năng / hoàn cảnh cản |
| Dùng với tính từ? | ✅ có (안 비싸요) | ❌ không |
| Ví dụ 가다 | 안 가요 = không đi | 못 가요 = không đi được |
| Ví dụ 먹다 | 안 먹어요 = không ăn (không thích) | 못 먹어요 = không ăn được (dị ứng) |
...
| Khẳng định | + 안 | + 못 |
|:---:|:---:|:---:|
| 공부해요 (học) | 공부 **안** 해요 | 공부 **못** 해요 |
| 운동해요 (tập) | 운동 **안** 해요 | 운동 **못** 해요 |
| 일해요 (làm việc) | 일 **안** 해요 | 일 **못** 해요 |

> ⚠️ **Sai thường gặp:** ❌ 안 공부해요 (sai!) → ✅ 공부 **안** 해요. Tách danh từ ra trước, chèn 안/못, rồi mới tới 해요.
...
| Ngắn | Dài | Nghĩa |
|:---:|:---:|---|
| 안 가요 | 가**지 않아요** | không đi |
| 안 먹어요 | 먹**지 않아요** | không ăn |
| 못 가요 | 가**지 못해요** | không đi được |
| 못 먹어요 | 먹**지 못해요** | không ăn được |
...
**Phần B — Thêm 못 cho đúng:**
6. 가요 →
7. 자요 →
8. 운동해요 → (ca 하다)

**Phần C — Đổi sang dạng dài -지 않다 hoặc -지 못하다:**
9. 안 먹어요 → (dài)
10. 못 가요 → (dài)

**Phần D — Chọn từ phủ định đặc biệt + dịch:**
11. "Tôi không có thời gian." (있다 → ?)
12. "Tôi không biết." (알다 → ?)
13. "Cái này không ngon." (맛있다 → ?)
14. Phân biệt nghĩa: 안 가요 vs 못 가요.
15. Sửa câu sai: 안 공부해요.

### ✅ Đáp án

**A:** 1. **안** 가요 · 2. **안** 먹어요 · 3. **안** 비싸요 · 4. 공부 **안** 해요 · 5. **안** 좋아요
**B:** 6. **못** 가요 · 7. **못** 자요 · 8. 운동 **못** 해요
**C:**
9. 먹**지 않아요** (*mơk-jji a-na-yo*)
10. 가**지 못해요** (*ka-ji mo-thae-yo*)
**D:**
11. 시간이 **없어요**. (*si-ga-ni ơp-sơ-yo.*)
12. (저는) **몰라요**. (*mol-la-yo.*)
13. 이거 **맛없어요**. (*i-gơ ma-dơp-sơ-yo.*)
14. **안** 가요 = không đi (không muốn / sự thật); **못** 가요 = không đi *được* (bất khả, hoàn cảnh cản).
15. Sai vì 하다 phải tách: ✅ 공부 **안** 해요.
...
- **안** + V/Adj = "không (làm)" (ý chí/sự thật); dùng được cả tính từ.
- **못** + V = "không thể (làm)" (bất khả); chỉ dùng với động từ hành động.
