+++
title = "Ngày 12: Trợ từ 을/를, 에, 에서 trong tiếng Hàn"
description = "Học trợ từ tân ngữ 을/를, trợ từ 에 (đích đến, thời gian) và 에서 (nơi diễn ra hành động) trong tiếng Hàn. Ngày 12 series Premium 30 ngày tự học tiếng Hàn."
date = 2026-06-18
aliases = ["/tro-tu-eul-reul-e-eseo-tieng-han/",
  "/posting/tro-tu-eul-reul-e-eseo-tieng-han/"
]

[taxonomies]
categories = ["Tất cả", "premium", "Học tiếng Hàn"]
tags = ["hoc tieng han series", "học tiếng hàn", "ngữ pháp tiếng hàn", "tiếng hàn sơ cấp", "topik", "trợ từ tiếng hàn"]
[extra]
premium = true
price = 49000
premium_post_id = "premium-han30-12"
...
[[extra.faq]]
q = "Trợ từ 을/를 trong tiếng Hàn dùng để làm gì?"
a = "을/를 đánh dấu tân ngữ (đối tượng) của động từ tha động: sau phụ âm dùng 을, sau nguyên âm dùng 를. Ví dụ: 밥을 먹어요 (ăn cơm), 커피를 마셔요 (uống cà phê)."

[[extra.faq]]
q = "Trợ từ 에 và 에서 khác nhau thế nào trong tiếng Hàn?"
a = "에 chỉ đích đến (학교에 가요 - đi đến trường), thời gian (3시에 - lúc 3 giờ) và vị trí tĩnh với 있다 (집에 있어요). 에서 chỉ nơi diễn ra hành động (학교에서 공부해요 - học ở trường) và điểm xuất phát (집에서 와요 - đến từ nhà)."

[[extra.faq]]
q = "Khi nào dùng 에 và khi nào dùng 에서 với địa điểm?"
...
|---|:---:|---|
| **Phụ âm** (có 받침) | **을** | 밥**을** 먹어요 (ăn cơm) |
| **Nguyên âm** (không 받침) | **를** | 커피**를** 마셔요 (uống cà phê) |
...
|---|---|---|
| **Đích đến** (tới đâu) | 가다 (đi), 오다 (đến) | 학교**에** 가요 (đi đến trường) |
| **Thời gian** (lúc nào) | mọi động từ | 3시**에** 만나요 (gặp lúc 3 giờ) |
| **Vị trí tĩnh** (ở đâu) | 있다 (có/ở), 없다 | 집**에** 있어요 (ở nhà) |
...
|---|---|---|
| **Nơi diễn ra hành động** | "ở đâu (làm gì)" | 학교**에서** 공부해요 (học **ở** trường) |
| **Điểm xuất phát** | "từ đâu" | 집**에서** 와요 (đến **từ** nhà) |
...
| Câu | Trợ từ | Nghĩa |
|---|:---:|---|
| 학교**에** 가요. | 에 | Đi **đến** trường (di chuyển tới đích). |
| 학교**에서** 공부해요. | 에서 | Học **ở** trường (hành động tại chỗ). |
| 집**에** 있어요. | 에 | Ở nhà (tồn tại tĩnh). |
| 집**에서** 쉬어요. | 에서 | Nghỉ **ở** nhà (hành động nghỉ ngơi). |
...
**Phần B — Điền 에 hay 에서:**
4. 학교 ___ 가요 (đi đến trường)
5. 학교 ___ 공부해요 (học ở trường)
6. 집 ___ 있어요 (ở nhà)
7. 식당 ___ 밥을 먹어요 (ăn ở nhà hàng)

**Phần C — Dịch sang tiếng Hàn:**
8. Tôi uống cà phê ở quán cà phê. (카페 / 커피)
9. Tôi đi đến Hàn Quốc. (한국)
10. Tôi gặp (bạn) lúc 3 giờ. (3시 / 만나요)

**Phần D — Giải thích:**
11. Vì sao 학교에 가요 dùng 에 nhưng 학교에서 공부해요 dùng 에서?
12. Trợ từ 을/를 đánh dấu thành phần gì trong câu?
13. 에 có dùng được với 오늘 (hôm nay) không?
14. Mẹo nhanh để chọn giữa 에 và 에서 với địa điểm là gì?

### ✅ Đáp án

**A:** 1. 밥**을** (phụ âm) · 2. 커피**를** (nguyên âm) · 3. 책**을** (phụ âm)
**B:** 4. 학교**에** 가요 (đích đến) · 5. 학교**에서** 공부해요 (hành động) · 6. 집**에** 있어요 (tĩnh) · 7. 식당**에서** 밥을 먹어요 (hành động)
**C:**
8. 저는 카페에서 커피를 마셔요.
9. 저는 한국에 가요.
10. 저는 3시에 만나요.
**D:**
11. 가다 là động từ **di chuyển tới đích** → 에; 공부하다 là **hành động diễn ra tại chỗ** → 에서.
12. **Tân ngữ** (đối tượng của động từ tha động).
13. **Không** — 오늘/어제/내일/지금 đứng trần, không gắn 에.
14. Có **hành động xảy ra** tại nơi đó → **에서**; chỉ **đi tới / tồn tại** → **에**.
