+++
title = "Ngày 26 — Kính ngữ (높임말) trong tiếng Hàn"
description = "Học kính ngữ tiếng Hàn ngày 26: đuôi -(으)시-, trợ từ 께서/께, động từ tôn kính 계시다·드시다·주무시다 và khiêm nhường. Series Premium 30 ngày → TOPIK."
date = 2026-06-18
aliases = ["/kinh-ngu-nopimmal-tieng-han/",
  "/posting/kinh-ngu-nopimmal-tieng-han/"
]
...
premium = true
price = 49000
premium_post_id = "premium-han30-26"
...
[[extra.faq]]
q = "Kính ngữ tiếng Hàn (높임말) là gì?"
a = "높임말 (kính ngữ) là cách nói thể hiện sự tôn trọng người nghe hoặc người được nhắc tới, dùng đuôi -(으)시-, trợ từ 께서/께 và một số động từ tôn kính đặc biệt như 계시다, 드시다, 주무시다. Đây là kiến thức bắt buộc khi nói với người lớn tuổi, cấp trên và khách hàng."

[[extra.faq]]
q = "Khi nào dùng đuôi -(으)시- trong kính ngữ tiếng Hàn?"
a = "Dùng -(으)시- khi CHỦ NGỮ của câu là người đáng kính (ông bà, thầy cô, sếp). Ví dụ: 가다 → 가세요/가십니다, 읽다 → 읽으세요. Lưu ý phân biệt với khiêm nhường (낮춤말) dùng khi nói về bản thân: 저, 드리다, 뵙다."

[[extra.faq]]
q = "Động từ tôn kính đặc biệt trong tiếng Hàn gồm những gì?"
...
| Tầng | Tôn trọng ai | Công cụ chính |
|---|---|---|
| **주체 높임** (chủ thể) | CHỦ NGỮ của câu (người làm hành động) | đuôi **-(으)시-**, 께서, 님 |
| **객체 높임** (đối tượng) | TÂN NGỮ / người nhận hành động | 께, động từ 드리다·뵙다·모시다 |
| **상대 높임** (người nghe) | NGƯỜI ĐANG NGHE mình nói | đuôi câu `-ㅂ니다`, `-요` |

> 🧠 **Nhớ nhanh:** "Ai làm" cao → dùng **시**; "ai nhận" cao → đổi **động từ khiêm nhường**; "ai nghe" cao → chọn **đuôi câu lịch sự**.
...
| Gốc | + 시 | Dạng -요 | Dạng -ㅂ니다 | Nghĩa |
|---|:---:|:---:|:---:|---|
| 가다 (đi) | 가시- | **가세요** | 가십니다 | (ông/bà) đi |
| 읽다 (đọc) | 읽으시- | **읽으세요** | 읽으십니다 | (ông/bà) đọc |
| 바쁘다 (bận) | 바쁘시- | 바쁘세요 | 바쁘십니다 | (sếp) bận |
| 앉다 (ngồi) | 앉으시- | 앉으세요 | 앉으십니다 | (mời) ngồi |
...
| Trợ từ thường | Trợ từ kính ngữ | Vai trò |
|:---:|:---:|---|
| 이/가 (chủ ngữ) | **께서** | đánh dấu chủ ngữ đáng kính |
| 은/는 (chủ đề) | **께서는** | chủ đề đáng kính |
| 에게/한테 (cho/đến) | **께** | người nhận đáng kính |

Thêm hai hậu tố danh từ lễ phép:
- **님** — gắn sau danh từ chỉ người để tôn kính: 선생 → **선생님** (thầy/cô), 사장 → **사장님** (giám đốc), 부모 → **부모님** (bố mẹ).
- **분** — lượng từ đếm người lịch sự (thay 명): 한 **분**, 두 **분** = một vị, hai vị.

| Câu thường | Câu kính ngữ |
|---|---|
| 친구가 와요. (Bạn đến.) | 사장님께서 **오세요**. (Giám đốc đến.) |
| 동생한테 줘요. (Cho em.) | 할아버지**께** 드려요. (Biếu ông.) |
| 사람 두 명 (hai người) | 손님 두 **분** (hai vị khách) |
...
| Thường | Tôn kính (chủ thể cao) | Nghĩa |
|:---:|:---:|---|
...
| Thường (về mình) | Khiêm nhường | Nghĩa |
|:---:|:---:|---|
| 나 (tôi) | **저** | tôi (khiêm tốn) |
| 우리 (chúng tôi) | **저희** | chúng tôi (khiêm tốn) |
| 주다 (cho — mình cho người trên) | **드리다** | biếu/dâng |
| 보다 / 만나다 (gặp người trên) | **뵙다 / 뵈다** | yết kiến/diện kiến |
| 묻다 (hỏi người trên) | **여쭙다 / 여쭈다** | thưa hỏi |
| 데리다 (dẫn người trên đi) | **모시다** | đưa/hộ tống |
...
**Phần B — Chọn động từ tôn kính đặc biệt đúng:**
6. 할아버지께서 집에 ____ (있다 → ?).
7. 부모님께서 식사를 ____ (먹다 → ?).
8. 선생님께서 교실에서 ____ (자다 → ?, hiếm — dùng cho ngủ trưa).
9. 사장님께서 회의에서 ____ (말하다 → ?, quá khứ).

**Phần C — Khiêm nhường & trợ từ:**
10. Đổi 나 → ? và 우리 → ? (khiêm nhường).
11. "Tôi tặng quà cho thầy": 선생님____ 선물을 ____. (điền trợ từ + động từ khiêm nhường).
12. Đổi trợ từ: 친구가 와요 → 할머니____ 오세요.
13. Đếm "hai vị khách": 손님 두 ____.
14. "Mai tôi diện kiến giám đốc": 내일 사장님을 ____.
15. Đúng hay sai: 저는 지금 가세요. Giải thích.
...
**B:**
6. **계세요** (있다 → 계시다)
7. **드세요** (먹다 → 드시다); trang trọng hơn: 잡수세요
8. **주무세요** (자다 → 주무시다)
9. **말씀하셨어요** (말하다 → 말씀하시다, quá khứ)

**C:**
10. 나 → **저**; 우리 → **저희**
11. 선생님**께** 선물을 **드렸어요** (hoặc 드립니다). (께 + 드리다)
12. 할머니**께서** 오세요. (이/가 → 께서)
13. 손님 두 **분**.
14. 내일 사장님을 **뵙겠습니다** (hoặc 뵈겠습니다).
15. **SAI.** Không tự gắn -시- cho bản thân. Phải nói: 저는 지금 **가요** / 갑니다. -세요 chỉ dùng cho người khác cao hơn.
...
- Trợ từ nâng cấp: 이/가 → **께서**, 에게/한테 → **께**; hậu tố **님**, lượng từ **분**.
