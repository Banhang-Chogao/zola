...
aliases = ["/git-remote-lam-viec-voi-repository-tu-xa/",
  "/posting/git-remote-lam-viec-voi-repository-tu-xa/"
]
[taxonomies]
...
> 📚 **Git & GitHub Series (Bài 6/15)** — Sau khi đã merge thành thạo ở [Bài 5](/posting/git-merge-va-xu-ly-conflict/), bài này đưa Git ra khỏi máy cá nhân với **git remote**.
...
- Không thể kích hoạt deploy tự động như [GitHub Actions deploy Zola](/posting/tu-dong-deploy-zola-github-actions/).
...
Trong các dự án mã nguồn mở, bạn thường có hai remote: `origin` (bản fork của bạn) và `upstream` (repo gốc) — kỹ thuật dùng nhiều khi đóng góp open source, bàn ở [Bài 9 về Pull Request](/posting/pull-request-quy-trinh-cong-tac-github/).
...
- **SSH**: `git@github.com:user/repo.git` — cần thiết lập khóa một lần (đã hướng dẫn ở [Bài 2](/posting/cai-dat-git-cau-hinh-lan-dau/)), sau đó push/pull không cần nhập gì.
...
Ba lệnh này sẽ được mổ xẻ chi tiết ở [Bài 8: push, pull, fetch](/posting/push-pull-fetch-dong-bo-voi-github/). Ở bài này, bạn chỉ cần hiểu remote là "đích đến" mà chúng hướng tới.
...
Ở **Bài 7**, chúng ta chính thức bước vào thế giới [GitHub: tạo tài khoản và repository đầu tiên](/posting/github-la-gi-tao-repository-dau-tien/) — nơi remote của bạn sẽ "sống".
