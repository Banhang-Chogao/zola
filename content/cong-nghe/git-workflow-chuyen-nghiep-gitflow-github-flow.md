...
aliases = ["/git-workflow-chuyen-nghiep-gitflow-github-flow/",
  "/posting/git-workflow-chuyen-nghiep-gitflow-github-flow/"
]
[taxonomies]
...
Đây chính là mô hình blog này áp dụng: mỗi thay đổi một nhánh, qua PR, CI xanh thì merge và [tự động deploy](/posting/tu-dong-deploy-zola-github-actions/). Đơn giản, nhanh, ít nhánh dài hạn.
...
Ở **Bài 14**, chúng ta tự động hóa toàn bộ quy trình kiểm thử và phát hành với [GitHub Actions — CI/CD cho người mới](/posting/github-actions-ci-cd-cho-nguoi-moi/).
