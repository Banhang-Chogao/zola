...
aliases = ["/push-pull-fetch-dong-bo-voi-github/",
  "/posting/push-pull-fetch-dong-bo-voi-github/"
]
[taxonomies]
...
> 📚 **Git & GitHub Series (Bài 8/15)** — Đã có repository GitHub ở [Bài 7](/posting/github-la-gi-tao-repository-dau-tien/), giờ ta học bộ ba đồng bộ, bắt đầu bằng **git push**.
...
Sau khi đã kết nối remote ở [Bài 6](/posting/git-remote-lam-viec-voi-repository-tu-xa/), việc đồng bộ diễn ra theo hai chiều:
...
Tiện lợi, nhưng vì gộp ngay nên có thể phát sinh conflict cần xử lý (kỹ năng đã học ở [Bài 5](/posting/git-merge-va-xu-ly-conflict/)). Một số người thích `git pull --rebase` để giữ lịch sử thẳng — chủ đề của [Bài 10 về rebase](/posting/git-rebase-lam-sach-lich-su-commit/).
...
Ở **Bài 9**, chúng ta học quy trình cộng tác chuẩn của GitHub: [Pull Request và cách review code](/posting/pull-request-quy-trinh-cong-tac-github/) — trái tim của làm việc nhóm hiện đại.
