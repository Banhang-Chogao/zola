...
aliases = ["/users-new-users-sessions-google-analytics/",
  "/posting/users-new-users-sessions-google-analytics/"
]
...
![Infographic: sơ đồ 1 user tạo nhiều session và mối quan hệ Users vs Sessions](/img/placeholder/placeholder-wide.svg)
...
![Infographic: bảng quyết định nên xem chỉ số nào theo mục tiêu](/img/placeholder/placeholder-wide.svg)
