...
aliases = ["/engagement-rate-bounce-rate-google-analytics/",
  "/posting/engagement-rate-bounce-rate-google-analytics/"
]
...
> 📚 **Series "10 ngày để hiểu Google Analytics" — Bài 3/5.** Ở [Bài 2](/posting/users-new-users-sessions-google-analytics/) ta đã đếm được *bao nhiêu người* và *bao nhiêu lượt*. Hôm nay chuyển sang câu hỏi quan trọng hơn: những lượt đó có *chất lượng* không?
...
Mình nhấn mạnh chữ *lệch search intent* vì đây là nguyên nhân âm thầm nhất. Một bài viết hay nhưng đặt sai từ khoá vẫn sẽ có engagement thấp. Nếu bạn chưa rõ khái niệm ý định tìm kiếm, nên đọc thêm [SEO là gì](/posting/seo-la-gi-huong-dan-co-ban-google-search/) và [Google Search hoạt động thế nào](/posting/google-search-hoat-dong-the-nao/) — hiểu Google ghép truy vấn với trang ra sao sẽ giúp bạn lý giải con số engagement.
...
👉 **Đọc tiếp:** [Bài 4 — Nguồn traffic trong GA4: Organic, Direct, Referral, Social, Paid](/posting/nguon-traffic-organic-direct-referral-social-paid/). Bạn có thể quay lại [Bài 1](/posting/google-analytics-la-gi-lo-trinh-10-ngay/) để ôn bản đồ tổng thể, hoặc xem cả series trong chuyên mục [Công nghệ](/categories/cong-nghe/).
