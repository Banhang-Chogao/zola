...
aliases = ["/fix-qa-gatekeeper-github-actions-merge-conflict-zola/",
  "/posting/fix-qa-gatekeeper-github-actions-merge-conflict-zola/"
]
...
## Checklist fix QA Gatekeeper GitHub Actions cho static blog
...
**Tài liệu tham khảo:**
- [GitHub Actions — Understanding workflow triggers](https://docs.github.com/en/actions/writing-workflows/choosing-when-your-workflow-runs/triggering-a-workflow)
...
- [Zola — Static site generator documentation](https://www.getzola.org/documentation/getting-started/overview/)
