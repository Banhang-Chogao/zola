...
aliases = ["/pull-request-quy-trinh-cong-tac-github/",
  "/posting/pull-request-quy-trinh-cong-tac-github/"
]
[taxonomies]
...
> 📚 **Git & GitHub Series (Bài 9/15)** — Đã biết đồng bộ ở [Bài 8](/posting/push-pull-fetch-dong-bo-voi-github/), giờ ta học trái tim của cộng tác GitHub: **Pull Request**.
...
- Tự động chạy **CI/CD** (kiểm thử, build) trước khi merge — chủ đề [Bài 14](/posting/github-actions-ci-cd-cho-nguoi-moi/).
...
Giả sử bạn đã làm việc trên một nhánh tính năng (từ [Bài 4](/posting/git-branch-lam-viec-voi-nhanh/)):
...
Với blog cá nhân hoặc dự án nhỏ, **squash** thường gọn nhất. Khái niệm rebase sẽ được làm rõ ở [Bài 10](/posting/git-rebase-lam-sach-lich-su-commit/).
...
2. Clone bản fork về máy, thêm remote `upstream` trỏ repo gốc (nhắc lại [Bài 6](/posting/git-remote-lam-viec-voi-repository-tu-xa/)).
...
Từ bài sau, series bước sang phần **nâng cao**. **Bài 10** mở đầu với [git rebase — làm sạch lịch sử commit](/posting/git-rebase-lam-sach-lich-su-commit/), một công cụ mạnh nhưng cần dùng đúng cách.
