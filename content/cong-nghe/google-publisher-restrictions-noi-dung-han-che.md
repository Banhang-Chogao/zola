...
aliases = ["/google-publisher-restrictions-noi-dung-han-che/",
  "/posting/google-publisher-restrictions-noi-dung-han-che/"
]
[taxonomies]
...
[Bài 1](/posting/google-adsense-la-gi-chinh-sach-chuong-trinh/) đã vẽ khung Program policies. [Bài 4](/posting/google-publisher-policies-noi-dung-bi-cam/) = **cấm**. **Bài 5** = **giới hạn** — ranh giới mỏng nhưng quan trọng cho publisher tin tức, sức khỏe, lifestyle.
...
- Account disabled (thường thuộc [Policies — Bài 4](/posting/google-publisher-policies-noi-dung-bi-cam/))
- Từ chối đăng ký lần đầu (thường do eligibility + Policies — [Bài 2](/posting/dieu-kien-du-tu-cach-adsense/))
...
[Bài 3](/posting/website-san-sang-cho-adsense/) nhấn site readiness — unique content, navigation. Readiness pass **không** bảo vệ RPM nếu chủ đề restricted.
...
Nội dung gợi cảm, nudity, fetish, sexual entertainment, sex tips, enhancement drugs — **không** explicit như Policies (porn) nhưng vẫn **restricted**. Ranh giới Policies vs Restrictions ở adult: **explicit = Policies** ([Bài 4](/posting/google-publisher-policies-noi-dung-bi-cam/)); **suggestive/gratifying = Restrictions**.
...
[Bài 3](/posting/website-san-sang-cho-adsense/) yêu cầu layout không che nội dung — đồng thời **không che ad** sau khi gắn code.
...
| | **Publisher Policies** ([Bài 4](/posting/google-publisher-policies-noi-dung-bi-cam/)) | **Publisher Restrictions** (Bài 5) |
|---|---|---|
...
- Uranium series — khoa học; [Bài 4](/posting/google-publisher-policies-noi-dung-bi-cam/) đã tách khỏi shocking war graphic.
...
- Không sticky ad che TOC/menu ([Bài 3](/posting/website-san-sang-cho-adsense/) UX).
- Không CSS `z-index` che ad unit.

Kết hợp [SEO Foundation](/posting/seo-la-gi-huong-dan-co-ban-google-search/) — traffic đến URL restricted vẫn có giá trị brand/affiliate khác, không chỉ AdSense.
...
Sau [audit Policies Bài 4](/posting/google-publisher-policies-noi-dung-bi-cam/), tôi chạy thêm checklist bám [10437795](https://support.google.com/adsense/answer/10437795?hl=en):
...
Sau khi hiểu **Restrictions**, bước tiếp trong series là [**Bài 6: Phân biệt Policies và Restrictions**](/posting/phan-biet-policies-va-restrictions-adsense/) thực chiến và **helpful content** (Bài 7). Trước mắt:
...
3. **Giữ readiness** [Bài 3](/posting/website-san-sang-cho-adsense/) — Restrictions không thay thế unique content.

Chưa pass eligibility? [Bài 2](/posting/dieu-kien-du-tu-cach-adsense/). Chưa audit Policies? [Bài 4](/posting/google-publisher-policies-noi-dung-bi-cam/).

## Tóm lại {#tom-lai}

**Google Publisher Restrictions** đánh dấu nội dung **được phép** nhưng **quảng cáo bị giới hạn** — ít bid, Google Ads không serve, RPM/fill thấp hơn. Khác **Publisher Policies** ([Bài 4](/posting/google-publisher-policies-noi-dung-bi-cam/)) là **cấm tuyệt đối** và rủi ro disable account.
...
Series: Bài 1 (khung) → Bài 2 (eligibility) → Bài 3 (readiness) → Bài 4 (Policies cấm) → **Bài 5** (Restrictions giới hạn). Tiếp theo: [**Bài 6: Phân biệt Policies và Restrictions**](/posting/phan-biet-policies-va-restrictions-adsense/) — đọc Policy center và lên kế hoạch chủ đề site.
