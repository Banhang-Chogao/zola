...
aliases = ["/git-rebase-lam-sach-lich-su-commit/",
  "/posting/git-rebase-lam-sach-lich-su-commit/"
]
[taxonomies]
...
> 📚 **Git & GitHub Series (Bài 10/15)** — Bắt đầu phần nâng cao. Sau khi thành thạo [Pull Request ở Bài 9](/posting/pull-request-quy-trinh-cong-tac-github/), ta học **git rebase** để làm sạch lịch sử.
...
Nhắc lại từ [Bài 8](/posting/push-pull-fetch-dong-bo-voi-github/): khi `git pull`, mặc định Git sẽ merge. Nếu muốn giữ lịch sử thẳng, bạn có thể dùng:
...
Ở **Bài 11**, chúng ta khám phá ba công cụ cứu cánh nâng cao: [git stash, cherry-pick và reflog](/posting/git-stash-cherry-pick-reflog-nang-cao/).
