...
(function (global) {
      ...
      options: {
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              label(c) {
                return ` ${c.dataset.label}: ${FDashboardInsights.formatVnd(c.parsed.y)}`;
              },
            },
          },
        },
          ...
          tooltip: {
            callbacks: {
              label(c) {
                ...
                return ` ${it.date || ""} · ${FDashboardInsights.formatVnd(c.parsed.x)}`;
              },
            },
          },
        },
  ...
  function renderAll(charts) {
    ...
    const balanceEl = document.getElementById("fd-chart-area");
    const topTxnsEl = document.getElementById("fd-chart-treemap");
    const dailyNetEl = document.getElementById("fd-chart-waterfall");
