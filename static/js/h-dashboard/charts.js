/**
 * Chart.js visualizations for H-Dashboard.
 */
(function (global) {
  "use strict";
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              label(ctx) {
                const v = ctx.parsed;
                return ` ${ctx.label}: ${HDashboardInsights.formatVnd(v)}`;
              },
            },
          },
        },
      ...
      options: {
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              label(c) {
                return ` ${c.dataset.label}: ${HDashboardInsights.formatVnd(c.parsed.y)}`;
              },
            },
          },
        },
          ...
          tooltip: {
            callbacks: {
              label(c) {
                ...
                return ` ${it.date || ""} · ${HDashboardInsights.formatVnd(c.parsed.x)}`;
              },
            },
          },
        },
  ...
  global.HDashboardCharts = { renderAll, destroyAll };
