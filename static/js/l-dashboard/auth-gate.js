...
(function (global) {
  ...
  function populateUserBar(user) {
    const bar = document.querySelector("[data-ld-user-bar]");
    if (!bar) return;
    const avatar = bar.querySelector("[data-ld-user-avatar]");
    const name = bar.querySelector("[data-ld-user-name]");
    const email = bar.querySelector("[data-ld-user-email]");
  ...
  function showLoginError(code) {
    const el = document.querySelector("[data-ld-login-error]");
    if (!el) return;
  ...
  async function init() {
    ...
    const loginBtn = root.querySelector("[data-ld-action='github-login']");
    const logoutBtn = root.querySelector("[data-ld-action='logout']");
    const hint = root.querySelector("[data-ld-login-hint]");
