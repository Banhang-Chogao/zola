...
- `gh-run-list-monitor-deploy` [mid] score=0.70 — Trung bình top-5 = 0.70 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
- `kiem-tra-trang-thai-pr-sau-khi-merge` [mid] score=0.70 — Trung bình top-5 = 0.70 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
...
- `kinh-nghiem-xay-cms-v2-cho-blog-zola` [mid] score=0.68 — Trung bình top-5 = 0.68 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
...
- `qa-gatekeeper-tu-fix-loi-blog` [mid] score=0.63 — Trung bình top-5 = 0.63 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
...
- `zola-vs-hugo` [mid] score=0.61 — Trung bình top-5 = 0.61 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
- `giai-quyet-merge-conflict-tu-dong-ci-cd` [mid] score=0.61 — Trung bình top-5 = 0.61 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
- `so-sanh-timo-vs-tnex` [mid] score=0.60 — Trung bình top-5 = 0.60 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
- `google-preferred-sources-6-tuong-lai-seo` [mid] score=0.60 — Trung bình top-5 = 0.60 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
...
- `lam-theme-log-sua-menu-cong-cu` [mid] score=0.57 — Trung bình top-5 = 0.57 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
- `loi-yaml-github-actions-workflow-invalid-case-study` [mid] score=0.57 — Trung bình top-5 = 0.57 < 0.70 — cần thêm bài cùng intent hoặc làm sâu nội dung cluster.
...
- `nha-tranh` [low] score=0.22 — Top semantic score thấp (0.30) — nội dung quá khác biệt trong cluster.
...
- `google-preferred-sources-4-chien-luoc-noi-dung` [low] score=0.16 — Top semantic score thấp (0.19) — nội dung quá khác biệt trong cluster.
