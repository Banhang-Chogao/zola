# Vaccine Library Archive

This file contains detailed documentation for all vaccines (V1-V29) referenced in CLAUDE.md. 
For quick reference and active policies, see CLAUDE.md §4 (Vaccine Library Headers).

**Archive Purpose:**
- Full symptom descriptions, root causes, and fixers for each vaccine
- Historical evidence and validation procedures
- Detailed prevention rules (preserved for future reference)
- Learning logs and incidents

**For Active Use:** See CLAUDE.md and reference specific vaccine number (V1-V29).
